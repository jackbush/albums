...
export default {
  ...
  items: [
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0176.jpg",
          alt: "A grey and rust-coloured limestone tower rising into mist, a bird of prey gliding past on the right",
        },
        {
          src: "./media/IMG_0180.jpg",
          alt: "Twin rock pinnacles split by a dark cleft, their tops lost in white fog",
        },
        {
          src: "./media/IMG_0188.jpg",
          alt: "A line of banded limestone buttresses fading one behind another into fog",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0390.jpg",
          alt: "A brick bell tower at the end of a narrow street in Antequera, one side of the street in deep shadow against a blue sky",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0325.jpg",
          alt: "A stony track climbing between olive trees towards pale eroded hills",
        },
        {
          src: "./media/IMG_0322.jpg",
          alt: "A cyclist in a white helmet grinning astride a green bike with a striped handlebar bag, olive trees behind",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0584.jpg",
          alt: "A basin of pale flat-bedded limestone blocks under a white sky, low bushes filling the gaps",
        },
        {
          src: "./media/IMG_0472.jpg",
          alt: "Stacked limestone pillars of El Torcal de Antequera above holm oak scrub, mist behind them",
        },
        {
          src: "./media/IMG_0515.jpg",
          alt: "Layered karst towers standing in ranks above dark green scrub, El Torcal de Antequera",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0613.jpg",
          alt: "A DFDS ferry at the quayside at first light, seen from inside a car waiting to board",
        },
        {
          src: "./media/IMG_0632.jpg",
          alt: "A woman in a green down jacket and woollen hat laughing on deck beside an orange lifeboat, the port behind her",
        },
        {
          src: "./media/IMG_0658.jpg",
          alt: "The Moroccan flag on the stern rail as the ferry passes the container cranes of Tanger Med",
        },
        {
          src: "./media/IMG_0619.jpg",
          alt: "A woman silhouetted against the ferry windows at sunrise, the water outside pale gold",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0703.jpg",
          alt: 'A coffee tuk-tuk on an empty beach, its awning painted "I need more coffee", the sea behind',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0743.jpg",
          alt: "A dirt road curving through pines into low sun, a rider small in the dust ahead",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_0786.jpg",
          alt: "Washing laid out to dry on a flat roof above a valley, snow peaks of the High Atlas at its head",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_1011.jpg",
          alt: "Black and white goats grazing along a red earth ridge, snow-covered mountains far behind",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_1171.jpg",
          alt: "A dark ridge under a band of orange and deep blue left on the horizon after sunset",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        ...
        },
        {
          ...
          alt: "A flat-topped mesa striped pink and grey standing above rolling desert",
        },
        {
          src: "./media/IMG_1208.jpg",
          alt: "A lone cyclist on a pale track in the middle of a wide red basin",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "Red crumpled rock walls rising above a green valley floor of cultivated terraces and bare trees",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_1470.jpg",
          alt: "Bare silver poplars along a shallow river below a wall of knuckled red sandstone",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "A white van with a roof rack rounding a bend on a mountain road, layered plateaux dropping away beyond",
        },
      ],
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_1581.jpg",
          alt: "A weathered wooden cross on a clifftop, a figure sitting on the rocks opposite and a volcanic cone in the haze behind",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_1691.jpg",
          alt: "A woman in a helmet and check shirt standing beside a pink mountain bike, flat-topped mesas behind her",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_1737.jpg",
          alt: "Desert scrub and acacia in the foreground, twin volcanic cones on the far horizon",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "A Barbary macaque sitting upright on a branch in a cedar wood, looking off to one side",
        },
      ],
    },
      ...
      images: [
        {
          ...
          alt: "Cattle egrets lifting off a palm crown against a white sky",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        ...
        },
        {
          ...
          alt: "A vulture perched on a ledge halfway up a pale limestone cliff",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "A Spanish ibex standing in dense green undergrowth, looking back over its shoulder",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "Steep wooded slopes and rock ribs below cloud sitting on the tops",
        },
      ],
    },
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_2342.jpg",
          alt: "A walker looking up at an overhanging limestone wall beside the path, a yellow jacket strapped to her pack",
        },
        {
    ...
    },
    {
      ...
      images: [
        {
          src: "./media/IMG_2463.jpg",
          alt: "A dolphin breaking the surface in deep blue water beside a ship's wake",
        },
      ],
    },
  ],
