...
export default {
  title: 'Iceland, Following the Sagas',
  description: 'Three days around the west with the sagas for an itinerary, in weather that changed its mind hourly.',
  date: 'June 2013',
  cover: './media/jb20130611iceland854.jpg',
  ...
  items: [
      ...
      images: [
        {
          ...
          alt: 'A fair-haired man in a dark jumper and white collar standing in the middle of an empty road, hands on hips',
        },
        {
          src: './media/jb20130609iceland612.jpg',
          alt: 'A dark-haired man in a mustard jumper on the same road, green field and a flat-topped hill behind him',
        },
      ],
      ...
      images: [
        {
          ...
          alt: 'A man in blue shorts and walking boots standing in the long grass above the shore, sea and fog behind him',
        },
        {
          src: './media/jb20130610iceland635.jpg',
          alt: 'A man in black shorts and one striped sock grinning on the same bank, the water behind him white with fog',
        },
      ],
      caption: 'Before.',
    },
    ...
    },
    {
      ...
      images: [
        ...
        {
          src: './media/jb20130611iceland783.jpg',
          alt: 'A man wrapped to the chin in an orange sleeping bag beside a bicycle, clothes strewn over the paving outside the pool',
        },
      ],
      caption: 'In, and out.',
    },
